    ...
    create: function (config) {
        ...
        sockets.on('connection', function (socket) {
            ...
            socket.on('log', function (data) {
                socket_stack.forEach(function (sk) {
                    sk.emit('log', data);
                });
            });
            socket.on('log:json', function (data) {
                socket_stack.forEach(function (sk) {
                    sk.emit('log:json', data);
                });
            });
            socket.on('log:html', function (data) {
                socket_stack.forEach(function (sk) {
                    sk.emit('log:html', data);
                });
            });
